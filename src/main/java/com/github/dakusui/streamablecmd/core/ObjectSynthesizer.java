...
import com.github.dakusui.streamablecmd.exceptions.StreamableCmdException;
...
public abstract class ObjectSynthesizer<T> {
  ...
  protected ObjectSynthesizer(Class<T> anInterface) {
    StreamableCmdException.check(anInterface, Objects::nonNull);
    StreamableCmdException.check(anInterface, Class::isInterface);
