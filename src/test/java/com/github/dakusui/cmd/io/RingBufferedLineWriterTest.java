...
public class RingBufferedLineWriterTest {
	@Test public void write_hello_once() {
	...
	@Test public void write_hello_twice() {
		RingBufferedLineWriter ringWriter = new RingBufferedLineWriter(3);
	...
	@Test public void write_hello_3times() {
		RingBufferedLineWriter ringWriter = new RingBufferedLineWriter(3);
		ringWriter.write("hello1");
		ringWriter.write("hello2");
	...
	@Test public void write_hello_4times() {
		RingBufferedLineWriter ringWriter = new RingBufferedLineWriter(3);
		ringWriter.write("hello1");
		ringWriter.write("hello2");
		ringWriter.write("hello3");
